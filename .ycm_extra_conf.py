# Generated by YCM Generator at 2016-10-14 13:24:55.470600
...
flags = [
    ...
    'c',
    '-DASM_FILE=1',
    '-DGRUB_FILE=".include/grub/cache.h"',
    '-DGRUB_KERNEL=1',
    '-DGRUB_MACHINE=I386_PC',
    '-DGRUB_MACHINE_PCBIOS=1',
    '-DGRUB_PKGLIBDIR="/usr/local/lib/grub"',
    ...
    '-I../grub-core/lib/libgcrypt_wrap',
    '-I../grub-core/lib/posix_wrap',
    '-I../include',
    '-I../include/grub/gcrypt',
    '-I./grub-core/gnulib',
    '-I./grub-core/lib/libgcrypt-grub/src/',
    '-I./grub-core/lib/libgcrypt_wrap',
    '-I./grub-core/lib/minilzo',
    '-I./grub-core/lib/posix_wrap',
    '-I./grub-core/lib/xzembed',
    '-I./include',
    '-I./include/grub/gcrypt',
    '-I./lib/minilzo',
    '-I./lib/posix_wrap',
